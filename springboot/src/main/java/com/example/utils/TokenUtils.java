...
public class TokenUtils {
    ...
    private static FactoryService staticFactoryService;
    ...
    public void setUserService() {
        ...
        staticFactoryService = factoryService;
    }
    ...
    public static Account getCurrentUser() {
        try {
            ...
            if (ObjectUtil.isNotEmpty(token)) {
                ...
                } else if (RoleEnum.FACTORY.name().equals(role)) {
                    return staticFactoryService.selectById(Integer.valueOf(userId));
                }
            }
        } catch (Exception e) {
